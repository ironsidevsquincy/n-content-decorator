...
describe('Primary Image Transform', () => {
	...
	context('with remove image option', () => {

		context('with a main image', () => {

			it('sets main image to undefined', () => {
				const result = subject(fixture, {removeImage: true});
				expect(result).to.be.undefined;
			});
		...
		context('with no main image', () => {
			...
			it('returns undefined', () => {
				const result = subject(undefined, {removeImage: true});
				expect(result).to.be.undefined;
			});
